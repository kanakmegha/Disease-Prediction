...
# Define a list of symptoms expected by your model
symptoms_list = [
...
def predict():
    try:
        ...
        # Ensure symptoms are in the correct format for prediction
        symptoms_input = [1 if symptom in symptoms else 0 for symptom in symptoms_list]
